...
for subj in subjs:
    ...
    subj_df.to_csv('/Users/shibozhang/Documents/Beyourself/beyourself-label/BeYourself/CLEAN/'+subj+'/labeling_'+subj+'_for_analysis.csv',index = None)
